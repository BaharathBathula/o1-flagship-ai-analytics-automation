...
insight_payload = generator.generate(results)
print("Insights generated.")
print("Executive Summary:", insight_payload["executive_summary"])
report_path = delivery.export_metrics_to_json(results, filename="report_metrics.json")
report_path = delivery.export_full_report_to_json(
    results, insight_payload, filename="report_full.json"
)
python3 main.py
